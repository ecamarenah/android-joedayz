package com.android.joedayz.demo;

import java.util.HashMap;
import java.util.LinkedList;

import com.android.joedayz.demo.R;
...
public class Main extends Activity {
	...
	static String feedUrl = "http://www.joedayz.org/web/rss.xml";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        setTitle("Lector de feed JoeDayz");
